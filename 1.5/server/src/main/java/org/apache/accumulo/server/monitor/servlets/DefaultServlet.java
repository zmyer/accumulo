...
public class DefaultServlet extends BasicServlet {
  ...
  private void doHdfsTable(StringBuilder sb) throws IOException {
    ...
    if (fs instanceof DistributedFileSystem) {
      ...
      String href = "http://" + dfs.getUri().getHost() + ":" + port;
      ...
      try {
        ...
        DatanodeInfo[] liveNodes = dfs.getClient().datanodeReport(FSConstants.DatanodeReportType.LIVE);
        DatanodeInfo[] deadNodes = dfs.getClient().datanodeReport(FSConstants.DatanodeReportType.DEAD);
